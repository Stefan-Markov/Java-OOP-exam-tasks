package PlayersAndMonstersSecondSolution.common;
...
public class ConstantMessages {
    ...
    public static final String DEFAULT_REPORT_SEPARATOR
            = "###";
    public static final String PLAYER_USERNAME_NULL_OR_EMPTY = "Player's username cannot be null or an empty string.";
    public static final String PLAYER_HEALTH_CANNOT_BE_EMPTY = "Player's health bonus cannot be less than zero.";
}
